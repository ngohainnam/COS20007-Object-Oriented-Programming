...
namespace SwinAdventure
{
    public class TestInventory
    {
        ...
        public void TestTakenItem()
        {
            ...
            Assert.IsTrue(inventory.HasItem(axe.FirstID)); // Ensure the item is still in the inventory after being taken one we put

            Item takeItem = inventory.Take(axe.FirstID); // Fetch the axe
